...
public class AStarGrader implements Runnable {
  ...
  public void runTest(int i, String file, String desc, GeographicPoint start, GeographicPoint end) {
    ...
    GraphLoader.loadRoadMap("/Users/mateusz/IdeaProjects/UCSDGraphs/data/graders/mod3/" + file, graph);
    CorrectAnswer corr = new CorrectAnswer("/Users/mateusz/IdeaProjects/UCSDGraphs/data/graders/mod3/" + file + ".answer", false);
